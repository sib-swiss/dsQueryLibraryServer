...
union all select 'ATTRIBUTE_DEFINITION'  as tbl, 'ATTRIBUTE_TYPE_CONCEPT_ID'      as clmn, attribute_type_concept_id       as tbl_concept_id,CONCEPT_ID,concept_name,vocabulary_id from ATTRIBUTE_DEFINITION left join concept  on (attribute_type_concept_id = CONCEPT_ID)
